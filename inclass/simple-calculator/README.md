...
- [ ] \[+5\] If the user enters a decimal, it should not crash. Equally, if the user enters an integer, the calculations should operate on an integer. If the user enters a decimal, the calculations should operate on the float.

## Submission

Commit and push your code to GitHub. Upload the GitHub link to Canvas.
